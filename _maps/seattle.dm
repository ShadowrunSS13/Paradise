...
*/
	...
	#include "map_files\Seattle\Seattle.V1A.dmm"
	#include "map_files\Seattle\z2.dmm"
	#include "map_files\Seattle\z3.dmm"
	#include "map_files\Seattle\z4.dmm"
	#include "map_files\generic\z5.dmm"
	#include "map_files\generic\z6.dmm"
	#include "map_files\generic\z7.dmm"

	#define MAP_FILE "SeattleV1A.dmm"
	#define MAP_NAME "Seattle"
...
DECLARE_LEVEL(EMPTY_AREA_2, CROSSLINKED, list(REACHABLE)))
	...
	#define USING_MAP_DATUM /datum/map/seattle

#elif !defined(MAP_OVERRIDE)

	#warn a map has already been included, ignoring Seattle.
